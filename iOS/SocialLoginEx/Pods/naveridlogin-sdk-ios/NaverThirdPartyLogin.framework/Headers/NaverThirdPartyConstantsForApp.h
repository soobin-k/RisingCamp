...
#define kServiceAppUrlScheme    @"socialloginex"

#define kConsumerKey            @"H8eC9gQh9wgnpjrfpbAI"
#define kConsumerSecret         @"H8eC9gQh9wgnpjrfpbAI"
#define kServiceAppName         @"소셜 로그인 연습"
